...
const BackendNode: React.FC<NodeProps<WorkspaceNodeData>> = ({ id, data, selected }) => {
  ...
  return (
    <div className={`node node-backend ${selected ? 'selected' : ''}`}>
      <div className="node-header">
        <div className="node-type-badge">Backend</div>
        <button

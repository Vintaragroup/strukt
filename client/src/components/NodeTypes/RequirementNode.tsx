...
const RequirementNode: React.FC<NodeProps<WorkspaceNodeData>> = ({ id, data, selected }) => {
  ...
  return (
    <div className={`node node-requirement ${selected ? 'selected' : ''}`}>
      <div className="node-header">
        <div className="node-type-badge">Requirement</div>
        <button

...
const RootNode: React.FC<NodeProps<WorkspaceNodeData>> = ({ id, data, selected }) => {
  ...
  return (
    <div className={`node node-root ${selected ? 'selected' : ''}`}>
      <div className="node-header">
        <div className="node-type-badge">Root</div>
        <button
